...
<div class="wx-add-ui formspacer">
	<div class='wx-add-item-photo wx-add-item-dropdown'>
		<select id='wx-select-photo' class='wx-component-select' name='noname'>
			...
			<option value='flickr'><?php echo __( 'Flickr Photo Feed' ); ?></option>
			<!--option value='google.picasa'><?php echo __( 'Google Picasa Feed' ); ?></option-->
			<option value='foursquare'><?php echo __( 'Foursquare Venue Photos' ); ?></option>
		</select>
	</div>
	...
	<div class='wx-add-photo-value wx-photo-reveal wx-reveal'>
		...
		<label for='wx-photo-url' id='wx-foursquare-url' class='wx-photo-label'><?php echo __( 'Foursquare Venue Page URL' ); ?></label>
		<label for='wx-photo-url' id='wx-flickr-url' class='wx-photo-label'><?php echo __( 'Flickr User Photostream Page URL' ); ?></label>
		<label for='wx-photo-url' id='wx-google-picasa-email' class='wx-photo-label'><?php echo __( 'Google Picasa E-mail' ); ?></label>
	</div>
	...
	<div class='wx-add-title wx-photo-reveal wx-reveal'>
		...
		<label for='wx-photo-title'><?php echo __( 'Photo Stream Tab Name' ); ?></label>
	</div>
	
	<div class='wx-add-submit'>
		<input type='submit' id='wx-photo-submit' class='wx-submit' value='<?php echo __( 'Submit' ); ?>' name='add' />
	</div>
