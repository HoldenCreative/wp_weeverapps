...
<div class="wx-add-ui formspacer">
	...
	<div class='wx-add-item-option wx-proximity-reveal wx-reveal'>
		...
		<div id="wx-add-proximity-weever-cmsfeed-item" class="wx-proximity-item-choose">
    		...
    		<label for='wx-add-proximity-weever-cmsfeed-input' id='wx-add-proximity-weever-cmsfeed-input-label' class='wx-proximity-label'><?php echo __( 'R3S Feed - <a target="_blank" href="http://support.weeverapps.com/entries/20786801-what-is-the-add-an-r3s-feed-url-option-for">Details</a>', 'weever' ); ?></label>
		</div>
