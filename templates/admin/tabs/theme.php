        ...
        <div id="tabs">
        	...
        	<div id="tabs-1">
            	...
            	<div>
                	...
                	<legend><?php echo __( 'Basic Settings' ); ?></legend>
            	...
            	<div>
            		<fieldset>
                		<legend><?php echo __( 'Launch Screens, App Install Icon and Logo' ); ?></legend>
                		<br />
        	...
        	<div id="tabs-2">
				<div>
            		<fieldset>
                		...
                		<p><?php echo __( 'Enter CSS Classes in the appropriate text boxes below.' ); ?></p>

                		<table class="admintable">
                    		<tr>
                        		<td class="key">&lt;a&gt; <?php echo __( '<a> Links' ); ?></td>
                        		<td>
                    		...
                    		<tr>
                    			<td class="key"><?php echo __( 'Title Bar <span>' ); ?> &lt;span&gt;</td>
                        		<td>
                    		...
                    		<tr>
                        		<td class="key"><?php echo __( 'Buttons' ); ?></td>
                        		<td>
                    		...
                    		<tr>
                        		<td class="key"><?php echo __( 'Borders' ); ?></td>
                        		<td>
                	...
                	<fieldset>
                    	<legend><?php echo __( 'Title Bar Custom HTML' ); ?></legend>
                    	...
                    	<table class="admintable">
                        	<tr>
                            	<td class="key"><?php echo __('Custom HTML'); ?></td>
